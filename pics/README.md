...
推荐按「当前节点前缀 + 下划线序号」命名，后续管理最清楚。第一个时间节点可这样放：

```text
pics/timeline/2021_01.png
pics/timeline/2021_02.jpg
pics/timeline/2021_03.webp
```
...
```json
{
  ...
  "title": "第一次被记住的瞬间",
  "text": "这里写该时间点的文字。",
  "photos": ["2021_01", "2021_02", "2021_03"]
}
```

第二个节点可继续使用 `2022_01`、`2022_02`；可爱瞬间馆则可用 `cute_01_01`、`cute_01_02`，并在 `pics/cute/manifest.json` 对应 `photos` 数组写入相同名称。
